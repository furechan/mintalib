...
def CURVE(period: int = 20, *, item: str | None = None): ...
...
def QSF(period: int = 20, offset: int = 0, *, item: str | None = None): ...
...
def RVALUE(period: int = 20, *, item: str | None = None): ...
...
def SLOPE(period: int = 20, *, item: str | None = None): ...
...
def TSF(period: int = 20, offset: int = 0, *, item: str | None = None): ...
