...
def MACDV(n1: int = 12, n2: int = 26, n3: int = 9, *, src='*'): ...
...
__all__ = [
    ...
    'LAG', 'LOG', 'LROC', 'MACD', 'MACDV', 'MAD', 'MAV', 'MAX', 'MDI',
    'MFI', 'MIDPRICE', 'MIN', 'NATR', 'PDI', 'PPO', 'PRICE', 'QSF', 'RMA',
    'ROC', 'RSI', 'RVALUE', 'SAR', 'SHIFT', 'SIGN', 'SLOPE', 'SMA',
